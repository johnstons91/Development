...
day = '  TUESDAY   ' # Create a new string with no whitespace #this would be sanatizinng
new_day = day.strip()
print(new_day)
print (len(day)) 
print(len(new_day))
...
#create variable
language = 'python'
#create a variable to get half of hte length of the word
half = (len(language) / 2)

#create final bracket notation
#result = language[int((len(language) /2))]
