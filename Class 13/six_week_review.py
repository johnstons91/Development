...
gretting = 'hip hip hooray'
three_cheers = gretting * 3
...
while start >= end:
   print(start)
   start -= 1 #decrement (subtracting 1 from our start, each time through)
   if start == 75:
...
while True:
   ...
   if user_input[0].isnumeric() and  user_input[-1]:
      print("Congratulations")
      break
   else:
      continue
