...
# # AttributeError: 'int' object has no attribute 'append'-->(adding information to a list)
# num = 10
# num.append(5)
...
# num = int(input("Please enter your denominator: "))
...
# num_list = []
# try:
#             num_list.append(float(userin)) #generating error
#             print(num_list)
# except ValueError:
